<template>
  ...
  <SearchCard storage-key="roles" @search="search" @reset="resetQuery">
    <n-input v-model:value="query.name" :placeholder="t('role.searchPlaceholder')" clearable style="width: 180px" @keyup.enter="search" />
  </SearchCard>
