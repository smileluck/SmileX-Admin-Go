  ...
  <n-card>
    <template #header>
      <div class="page-header">
        ...
        <n-button type="error" ghost v-permission="['log:op:clear']" @click="confirmClear">清空</n-button>
      </div>
    </template>
...
import { clearOperationLogs, listOperationLogs } from '../../api'
  ...
  dialog.warning({
    ...
    onPositiveClick: async () => {
      try {
        ...
        message.success(`已清空 ${data.data.deleted} 条操作日志`)
        load()
      } catch (e: any) {
