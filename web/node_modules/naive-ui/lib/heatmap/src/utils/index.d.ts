import { HeatmapData, HeatmapDataItem, HeatmapFirstDayOfWeek } from "../public-types.js";
import { DayRect } from "../interface.js";
//#region src/heatmap/src/utils/index.d.ts
/** get color by value/maxValue */
declare function calcColorByValue(colors: string[], value: number | null | undefined, maxValue: number): string;
/**
 ...
 */
declare function completeDataGaps(data: HeatmapData, firstDayOfWeek: HeatmapFirstDayOfWeek, fillCalendarLeading: boolean): HeatmapData;
/**
 * Create a DayRect object with position information
 */
declare function createDayRect(item: HeatmapDataItem, calendarStartDate: number, weekStartOn: number, colors: string[], maxValue: number): DayRect;
/**
 * Create a sparse matrix from items with position information
 */
declare function createSparseMatrix<T>(rows: number, items: T[], getRowIndex: (item: T) => number, getColIndex: (item: T) => number): T[][];
/**
 * This creates a 7x53 matrix (typical year layout) filled with loading cells
 */
declare function createLoadingMatrix(firstDayOfWeek: HeatmapFirstDayOfWeek): DayRect[][];
/**
 ...
 */
declare function heatmapMockData(year?: 'recent' | number): HeatmapData;
//#endregion
