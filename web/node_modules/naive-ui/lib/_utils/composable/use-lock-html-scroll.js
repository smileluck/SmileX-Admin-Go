...
const lockHtmlScrollRightCompensationRef = (0, vue.ref)("0px");
function useLockHtmlScroll(lockRef) {
	...
	(0, vue.onMounted)(() => {
		watchStopHandle = (0, vue.watch)(lockRef, (value) => {
			if (value) {
				if (!lockCount) {
...
//#endregion
exports.lockHtmlScrollRightCompensationRef = lockHtmlScrollRightCompensationRef;
