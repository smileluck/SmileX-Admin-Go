...
var FadeInExpandTransition_default = (0, vue.defineComponent)({
	...
	setup(props, { slots }) {
		...
		function handleAfterEnter(el) {
			if (props.width) el.style.maxWidth = "";
			else if (!props.reverse) el.style.maxHeight = "";
			props.onAfterEnter?.();
		}
		return () => {
			...
			return (0, vue.h)(type, resolvedProps, slots);
		};
	}
});
//#endregion
module.exports = FadeInExpandTransition_default;
