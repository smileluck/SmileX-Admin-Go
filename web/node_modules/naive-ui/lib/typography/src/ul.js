...
var ul_default = (0, vue.defineComponent)({
	name: "Ul",
	props: ulProps,
	setup(props) {
		...
		const themeClassHandle = inlineThemeDisabled ? require__mixins_use_css_vars_class.useThemeClass("ul", void 0, cssVarsRef, props) : void 0;
		return {
