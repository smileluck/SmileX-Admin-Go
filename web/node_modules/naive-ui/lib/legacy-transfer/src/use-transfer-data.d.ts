import { CheckedStatus, Filter, Option, OptionValue } from "./interface.js";
import { Ref } from "vue";
//#region src/legacy-transfer/src/use-transfer-data.d.ts
...
declare function useTransferData(props: UseTransferDataProps, mergedDisabledRef: Ref<boolean>): {
