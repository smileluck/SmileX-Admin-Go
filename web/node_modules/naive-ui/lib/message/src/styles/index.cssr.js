...
//#region src/message/src/styles/index.cssr.ts
var index_cssr_default = require__utils_cssr_index.c([require__utils_cssr_index.cB("message-wrapper", `
 margin: var(--n-margin);
 z-index: 0;
...
})]), require__utils_cssr_index.cB("message", `
 ...
 flex-shrink: 0;
 `, [["default", "info", "success", "warning", "error", "loading"].map(type => require__utils_cssr_index.cM(`${type}-type`, [require__utils_cssr_index.c("> *", `
 ...
 right: 0;
 bottom: 0;
 `, [require__styles_transitions_icon_switch_cssr.iconSwitchTransition()])]), require__utils_cssr_index.cE("close", `
 ...
 `)])]), require__utils_cssr_index.cB("message-container", `
 z-index: 6000;
 position: fixed;
 height: 0;
 overflow: visible;
