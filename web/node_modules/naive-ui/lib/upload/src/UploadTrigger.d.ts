import { UploadTriggerDefaultSlotOptions } from "./interface.js";
import { SlotsType, VNode } from "vue";
//#region src/upload/src/UploadTrigger.d.ts
interface UploadTriggerSlots {
...
//#endregion
export { UploadTriggerSlots, _default as default };