...
const environmentSupportFile = require__utils_env_is_browser.isBrowser && window.FileReader && window.File;
		...
		for (const entry of entries) {
			...
			if (directory && isFileSystemDirectoryEntry(entry)) {
				...
				try {
					...
					require__utils_naive_warn.error("upload", "error happens when handling directory upload", e);
				}
				...
				require__utils_naive_warn.error("upload", "error happens when handling file upload", e);
			}
		}
	}
...
exports.environmentSupportFile = environmentSupportFile;
