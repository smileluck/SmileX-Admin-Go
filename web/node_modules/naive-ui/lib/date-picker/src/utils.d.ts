...
import { DatePickerGetDefaultTime, DatePickerGetRangeDefaultTime, FirstDayOfWeek, Value } from "./interface.js";
import "../../locales/index.js";
import { Ref } from "vue";
//#region src/date-picker/src/utils.d.ts
declare function getDerivedTimeFromKeyboardEvent(prevValue: number | null, event: KeyboardEvent): number;
declare function transformNaiveFirstDayOfWeekToDateFns(firstDayOfWeek: FirstDayOfWeek): FirstDayOfWeek;
interface DateItem {
  type: 'date';
  dateObject: {
    date: number;
...
//#endregion
export { DateItem, MonthItem, QuarterItem, YearItem, dateArray, extractRangeDefaultTime, extractSingleDefaultTime, getDefaultTime, getDerivedTimeFromKeyboardEvent, getMonthString, getQuarterString, getYearString, monthArray, pluckValueFromRange, quarterArray, strictParse, transformNaiveFirstDayOfWeekToDateFns, yearArray };