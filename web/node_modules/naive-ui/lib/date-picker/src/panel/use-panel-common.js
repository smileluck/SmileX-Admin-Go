...
//#region src/date-picker/src/panel/use-panel-common.ts
...
function usePanelCommon(props) {
	const { dateLocaleRef, timePickerSizeRef, timePickerPropsRef, localeRef, mergedClsPrefixRef, mergedThemeRef } = (0, vue.inject)(require_date_picker_src_interface.datePickerInjectionKey);
	...
	function disableTransitionOneTick() {
		if (props.active || props.panel) (0, vue.nextTick)(() => {
	...
	function handlePanelFocus(e) {
		...
		if (keyboardState.tab && e.target === el && el?.contains(e.relatedTarget)) doTabOut();
	}
	...
	const showMonthYearPanel = (0, vue.ref)(false);
