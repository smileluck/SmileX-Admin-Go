...
const require_transfer_src_TransferListItem = require("./TransferListItem.js");
let vue = require("vue");
...
var TransferList_default = (0, vue.defineComponent)({
	...
	render() {
		...
		if (options.length === 0) return this.mergedRenderEmpty?.() || ((0, vue.openBlock)(), (0, vue.createBlock)(require_empty_src_Empty.default, {
			key: 1,
			theme: mergedTheme.peers.Empty,
			themeOverrides: mergedTheme.peerOverrides.Empty
		}, null, 8, ["theme", "themeOverrides"]));
		const { mergedClsPrefix, virtualScroll, source, disabled, syncVLScroller } = this;
		return (0, vue.openBlock)(), (0, vue.createBlock)(require__internal_scrollbar_src_Scrollbar.default, {
			ref: "scrollerInstRef",
			...
			ref: "vlInstRef",
			style: { height: "100%" },
			class: require_vdom.normalizeClass(`${mergedClsPrefix}-transfer-list-content`),
			items: this.options,
			...
			return (0, vue.openBlock)(), (0, vue.createBlock)(require_transfer_src_TransferListItem, {
				source,
				key: item.value,
				value: item.value,
			...
			key: 3,
			class: require_vdom.normalizeClass(`${mergedClsPrefix}-transfer-list-content`)
		}, [require_vdom.normalizeVNode(() => options.map((option) => ((0, vue.openBlock)(), (0, vue.createBlock)(require_transfer_src_TransferListItem, {
			source,
			key: option.value,
			value: option.value,
