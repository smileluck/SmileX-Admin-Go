...
//#region src/menu/styles/light.ts
...
function self(vars) {
	...
	return {
		...
		itemColorActive: (0, seemly.changeColor)(primaryColor, { alpha: .1 }),
		itemColorActiveHover: (0, seemly.changeColor)(primaryColor, { alpha: .1 }),
		itemColorActiveCollapsed: (0, seemly.changeColor)(primaryColor, { alpha: .1 }),
...
const menuLight = require__mixins_use_theme.createTheme({
	name: "Menu",
	common: require__styles_common_light,
	peers: {
		Tooltip: require_tooltip_styles_light,
