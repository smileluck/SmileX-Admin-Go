...
//#region src/code/src/styles/index.cssr.ts
var index_cssr_default = require__utils_cssr_index.c([require__utils_cssr_index.cB("code", `
 font-size: var(--n-font-size);
 font-family: var(--n-font-family);
 `, [require__utils_cssr_index.cM("show-line-numbers", `
 display: flex;
 `), require__utils_cssr_index.cE("line-numbers", `
 user-select: none;
 padding-right: 12px;
 text-align: right;
 transition: color .3s var(--n-bezier);
 color: var(--n-line-number-text-color);
 `), require__utils_cssr_index.cM("word-wrap", [require__utils_cssr_index.c("pre", `
 ...
 font-size: inherit;
 font-family: inherit;
 `), require__utils_cssr_index.c("[class^=hljs]", `
