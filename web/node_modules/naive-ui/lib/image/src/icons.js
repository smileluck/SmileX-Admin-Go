...
let vue = require("vue");
//#region src/image/src/icons.tsx
function renderPrevIcon() {
	return (() => {
		const _cache = require_vdom.createVNodeCache("4483cc59868cde2a");
...
function renderNextIcon() {
	return (() => {
		const _cache = require_vdom.createVNodeCache("68488afe844d27a8");
		return _cache[0] || (_cache[0] = (0, vue.createElementVNode)("svg", {
			viewBox: "0 0 20 20",
			fill: "none",
			xmlns: "http://www.w3.org/2000/svg"
...
function renderCloseIcon() {
	return (() => {
		const _cache = require_vdom.createVNodeCache("61b21aa90691cd5d");
		return _cache[0] || (_cache[0] = (0, vue.createElementVNode)("svg", {
			viewBox: "0 0 20 20",
			fill: "none",
			xmlns: "http://www.w3.org/2000/svg"
...
exports.renderNextIcon = renderNextIcon;
exports.renderPrevIcon = renderPrevIcon;
