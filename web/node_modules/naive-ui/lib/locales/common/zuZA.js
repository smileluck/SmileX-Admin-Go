//#region src/locales/common/zuZA.ts
const zuZA = {
	name: "zu-ZA",
	global: {
		undo: "Hlehlisa",
	...
	Cascader: {
		...
		loading: "Iyalayisha",
		loadingRequiredMessage: (label) => `Sicela ulayishe zonke izizukulwane zika-${label} ngaphambi kokukhetha.`
	},
	Time: {
	...
	Transfer: {
		...
		clearAll: "Sula",
		total: (num) => `Ingqikithi yezinto ezingu-${num}`,
		selected: (num) => `Kukhethwe izinto ezingu-${num}`
	},
	Empty: { description: "Ayikho idatha" },
	Select: { placeholder: "Sicela ukhethe" },
	TimePicker: {
	...
	DynamicTags: { add: "Engeza" },
	Log: { loading: "Iyalayisha" },
	Input: { placeholder: "Sicela ufake" },
	InputNumber: { placeholder: "Sicela ufake" },
	DynamicInput: { create: "Dala" },
	ThemeEditor: {
