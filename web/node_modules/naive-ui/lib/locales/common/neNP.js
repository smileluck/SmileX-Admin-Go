//#region src/locales/common/neNP.ts
const neNP = {
	name: "ne-NP",
	global: {
	...
	Cascader: {
		...
		loading: "लोड हुँदैछ",
		loadingRequiredMessage: (label) => `कृपया जाँच्नुअघि ${label} का सबै वंशजहरू लोड गर्नुहोस्।`
	},
	Time: {
	...
	Transfer: {
		...
		total: (num) => `जम्मा ${num} वस्तुहरू`,
		selected: (num) => `${num} वस्तु चयन गरियो`
	},
	Empty: { description: "कुनै डेटा छैन" },
	Select: { placeholder: "कृपया चयन गर्नुहोस्" },
	TimePicker: {
	...
	DynamicTags: { add: "थप्नुहोस्" },
	Log: { loading: "लोड हुँदैछ" },
	Input: { placeholder: "कृपया प्रविष्ट गर्नुहोस्" },
	InputNumber: { placeholder: "कृपया प्रविष्ट गर्नुहोस्" },
	DynamicInput: { create: "सिर्जना गर्नुहोस्" },
	ThemeEditor: {
		title: "थिम सम्पादक",
