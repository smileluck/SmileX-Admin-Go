//#region src/locales/common/azAZ.ts
const azAZ = {
	name: "az-AZ",
	global: {
		undo: "Geri al",
	...
	Select: { placeholder: "Zəhmət olmasa, seçin" },
	TimePicker: {
	...
	DynamicTags: { add: "Əlavə et" },
	Log: { loading: "Yüklənir" },
	Input: { placeholder: "Zəhmət olmasa, daxil edin" },
	InputNumber: { placeholder: "Zəhmət olmasa, daxil edin" },
	DynamicInput: { create: "Yarat" },
	ThemeEditor: {
