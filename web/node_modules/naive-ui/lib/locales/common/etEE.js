//#region src/locales/common/etEE.ts
const etEE = {
	name: "et-EE",
	global: {
		undo: "Võta tagasi",
	...
	Empty: { description: "Andmeid pole" },
	Select: { placeholder: "Vali" },
	TimePicker: {
	...
	DynamicTags: { add: "Lisa" },
	Log: { loading: "Laeb" },
	Input: { placeholder: "Sisesta" },
	InputNumber: { placeholder: "Sisesta" },
	DynamicInput: { create: "Loo" },
	ThemeEditor: {
		title: "Teemaredaktor",
