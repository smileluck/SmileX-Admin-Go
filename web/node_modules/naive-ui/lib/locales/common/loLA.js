//#region src/locales/common/loLA.ts
const loLA = {
	name: "lo-LA",
	global: {
		undo: "ຍົກເລີກການເຮັດ",
	...
	Cascader: {
		...
		loading: "ກຳລັງໂຫຼດ",
		loadingRequiredMessage: (label) => `ກະລຸນາໂຫຼດລູກຫຼານທັງໝົດຂອງ ${label} ກ່ອນທີ່ຈະເລືອກ`
	},
	Time: {
	...
	Transfer: {
		...
		clearAll: "ລ້າງ",
		total: (num) => `ທັງໝົດ ${num} ລາຍການ`,
		selected: (num) => `ເລືອກແລ້ວ ${num} ລາຍການ`
	},
	Empty: { description: "ບໍ່ມີຂໍ້ມູນ" },
	Select: { placeholder: "ກະລຸນາເລືອກ" },
	TimePicker: {
	...
	DynamicTags: { add: "ເພີ່ມ" },
	Log: { loading: "ກຳລັງໂຫຼດ" },
	Input: { placeholder: "ກະລຸນາປ້ອນ" },
	InputNumber: { placeholder: "ກະລຸນາປ້ອນ" },
	DynamicInput: { create: "ສ້າງ" },
	ThemeEditor: {
