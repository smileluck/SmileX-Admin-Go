//#region src/locales/common/ltLT.ts
const ltLT = {
	name: "lt-LT",
	global: {
		undo: "Atšaukti",
	...
	Cascader: {
		...
		loading: "Įkeliama",
		loadingRequiredMessage: (label) => `Prieš pažymėdami įkelkite visus ${label} palikuonis.`
	},
	Time: {
	...
	Transfer: {
		...
		clearAll: "Išvalyti",
		total: (num) => `Iš viso ${num} elementų`,
		selected: (num) => `Pasirinkta ${num} elementų`
	},
	...
	DynamicTags: { add: "Pridėti" },
	Log: { loading: "Įkeliama" },
	Input: { placeholder: "Įveskite" },
	InputNumber: { placeholder: "Įveskite" },
	DynamicInput: { create: "Sukurti" },
	ThemeEditor: {
