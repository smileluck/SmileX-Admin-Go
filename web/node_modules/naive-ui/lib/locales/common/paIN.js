//#region src/locales/common/paIN.ts
const paIN = {
	name: "pa-IN",
	global: {
		undo: "ਅਣਕੀਤਾ",
	...
	Cascader: {
		...
		loadingRequiredMessage: (label) => `ਕਿਰਪਾ ਕਰਕੇ ਚੈੱਕ ਕਰਨ ਤੋਂ ਪਹਿਲਾਂ ${label} ਦੀਆਂ ਸਾਰੀਆਂ ਸੰਤਾਨਾਂ ਲੋਡ ਕਰੋ।`
	},
	Time: {
	...
	Transfer: {
		...
		clearAll: "ਸਾਫ਼ ਕਰੋ",
		total: (num) => `ਕੁੱਲ ${num} ਆਈਟਮਾਂ`,
		selected: (num) => `${num} ਆਈਟਮਾਂ ਚੁਣੀਆਂ`
	},
	Empty: { description: "ਕੋਈ ਡਾਟਾ ਨਹੀਂ" },
	Select: { placeholder: "ਕਿਰਪਾ ਕਰਕੇ ਚੁਣੋ" },
	TimePicker: {
	...
	DynamicTags: { add: "ਜੋੜੋ" },
	Log: { loading: "ਲੋਡ ਹੋ ਰਿਹਾ ਹੈ" },
	Input: { placeholder: "ਕਿਰਪਾ ਕਰਕੇ ਦਰਜ ਕਰੋ" },
	InputNumber: { placeholder: "ਕਿਰਪਾ ਕਰਕੇ ਦਰਜ ਕਰੋ" },
	DynamicInput: { create: "ਬਣਾਓ" },
	ThemeEditor: {
		title: "ਥੀਮ ਸੰਪਾਦਕ",
