//#region src/locales/common/roRO.ts
const roRO = {
	name: "ro-RO",
	global: {
		undo: "Anulează",
	...
	Cascader: {
		...
		loading: "Se încarcă",
		loadingRequiredMessage: (label) => `Încărcați toți descendenții lui ${label} înainte de a-l selecta.`
	},
	Time: {
	...
	Transfer: {
		...
		clearAll: "Șterge",
		total: (num) => `Total ${num} elemente`,
		selected: (num) => `${num} elemente selectate`
	},
	Empty: { description: "Nu există date" },
	...
	DynamicTags: { add: "Adaugă" },
	Log: { loading: "Se încarcă" },
	Input: { placeholder: "Introduceți" },
	InputNumber: { placeholder: "Introduceți" },
	DynamicInput: { create: "Creează" },
	ThemeEditor: {
