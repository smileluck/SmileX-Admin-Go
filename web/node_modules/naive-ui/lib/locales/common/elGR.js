//#region src/locales/common/elGR.ts
const elGR = {
	name: "el-GR",
	global: {
		undo: "Αναίρεση",
	...
	Cascader: {
		...
		loading: "Φόρτωση",
		loadingRequiredMessage: (label) => `Φορτώστε όλους τους απογόνους του ${label} πριν τον επιλέξετε.`
	},
	Time: {
	...
	Transfer: {
		...
		clearAll: "Καθαρισμός",
		total: (num) => `Σύνολο ${num} στοιχείων`,
		selected: (num) => `Επιλέχθηκαν ${num} στοιχεία`
	},
	Empty: { description: "Δεν υπάρχουν δεδομένα" },
	Select: { placeholder: "Παρακαλώ επιλέξτε" },
	TimePicker: {
	...
	DynamicTags: { add: "Προσθήκη" },
	Log: { loading: "Φόρτωση" },
	Input: { placeholder: "Παρακαλώ εισαγάγετε" },
	InputNumber: { placeholder: "Παρακαλώ εισαγάγετε" },
	DynamicInput: { create: "Δημιουργία" },
	ThemeEditor: {
