//#region src/locales/common/msMY.ts
const msMY = {
	name: "ms-MY",
	global: {
		undo: "Buat asal",
	...
	Cascader: {
		...
		loading: "Memuatkan",
		loadingRequiredMessage: (label) => `Sila muatkan semua turunan ${label} sebelum menandainya.`
	},
	Time: {
	...
	DynamicTags: { add: "Tambah" },
	Log: { loading: "Memuatkan" },
	Input: { placeholder: "Sila masukkan" },
	InputNumber: { placeholder: "Sila masukkan" },
	DynamicInput: { create: "Cipta" },
	ThemeEditor: {
		title: "Editor tema",
