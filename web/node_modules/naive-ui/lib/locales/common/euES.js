//#region src/locales/common/euES.ts
const euES = {
	name: "eu-ES",
	global: {
		undo: "Desegin",
	...
	Cascader: {
		placeholder: "Hautatu",
		loading: "Kargatzen",
		loadingRequiredMessage: (label) => `Kargatu ${label}(r)en ondorengo guztiak hautatu aurretik.`
	},
	Time: {
	...
	Transfer: {
		...
		clearAll: "Garbitu",
		total: (num) => `Guztira ${num} elementu`,
		selected: (num) => `${num} elementu hautatuta`
	},
	Empty: { description: "Ez dago daturik" },
	Select: { placeholder: "Hautatu" },
	TimePicker: {
	...
	DynamicTags: { add: "Gehitu" },
	Log: { loading: "Kargatzen" },
	Input: { placeholder: "Idatzi" },
	InputNumber: { placeholder: "Idatzi" },
	DynamicInput: { create: "Sortu" },
	ThemeEditor: {
		title: "Gai-editorea",
