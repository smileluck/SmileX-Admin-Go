//#region src/locales/common/teIN.ts
const teIN = {
	name: "te-IN",
	global: {
	...
	Cascader: {
		...
		loadingRequiredMessage: (label) => `చెక్ చేయడానికి ముందు ${label} యొక్క అన్ని వారసులను లోడ್ చేయండಿ.`
	},
	Time: {
	...
	Transfer: {
		...
		total: (num) => `మొత్తం ${num} అంశాలు`,
		selected: (num) => `${num} అంశాలు ఎంచుకోబడ్డాయి`
	},
	Empty: { description: "డేటా లేదు" },
	Select: { placeholder: "దయచేసి ఎంచుకోండಿ" },
	TimePicker: {
	...
	DynamicTags: { add: "జోడించండి" },
	Log: { loading: "లోడ్ అవుతోంది" },
	Input: { placeholder: "దయచేసి నమోదు చేయండి" },
	InputNumber: { placeholder: "దయచేసి నమోదు చేయండి" },
	DynamicInput: { create: "సృష్టించండి" },
	ThemeEditor: {
		title: "థీమ్ ఎడిటర్",
