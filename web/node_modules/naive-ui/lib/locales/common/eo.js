//#region src/locales/common/eo.ts
const eo = {
	name: "eo",
	global: {
		undo: "Malfari",
	...
	Empty: { description: "Neniu datumo" },
	Select: { placeholder: "Bonvolu elekti" },
	TimePicker: {
	...
	DynamicTags: { add: "Aldoni" },
	Log: { loading: "Ŝargado" },
	Input: { placeholder: "Bonvolu entajpi" },
	InputNumber: { placeholder: "Bonvolu entajpi" },
	DynamicInput: { create: "Krei" },
	ThemeEditor: {
		title: "Etosredaktilo",
