//#region src/locales/common/huHU.ts
const huHU = {
	name: "hu-HU",
	global: {
		undo: "Visszavonás",
	...
	Cascader: {
		...
		loading: "Betöltés",
		loadingRequiredMessage: (label) => `A kiválasztás előtt töltse be a(z) ${label} összes utódját.`
	},
	Time: {
	...
	Transfer: {
		...
		clearAll: "Törlés",
		total: (num) => `Összesen ${num} elem`,
		selected: (num) => `${num} elem kiválasztva`
	},
	Empty: { description: "Nincs adat" },
	Select: { placeholder: "Kérjük, válasszon" },
	TimePicker: {
	...
	DynamicTags: { add: "Hozzáadás" },
	Log: { loading: "Betöltés" },
	Input: { placeholder: "Kérjük, adja meg" },
	InputNumber: { placeholder: "Kérjük, adja meg" },
	DynamicInput: { create: "Létrehozás" },
	ThemeEditor: {
