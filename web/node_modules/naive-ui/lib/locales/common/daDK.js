//#region src/locales/common/daDK.ts
const daDK = {
	name: "da-DK",
	global: {
		undo: "Fortryd",
	...
	Select: { placeholder: "Vælg venligst" },
	TimePicker: {
	...
	DynamicTags: { add: "Tilføj" },
	Log: { loading: "Indlæser" },
	Input: { placeholder: "Udfyld venligst" },
	InputNumber: { placeholder: "Udfyld venligst" },
	DynamicInput: { create: "Opret" },
	ThemeEditor: {
		title: "Temaværktøj",
