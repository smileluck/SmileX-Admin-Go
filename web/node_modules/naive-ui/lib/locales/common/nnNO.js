//#region src/locales/common/nnNO.ts
const nnNO = {
	name: "nn-NO",
	global: {
		undo: "Angre",
	...
	Cascader: {
		placeholder: "Vel",
		loading: "Lastar",
		loadingRequiredMessage: (label) => `Last alle underpunkt av ${label} før du vel oppføringa.`
	},
	Time: {
	...
	Transfer: {
		...
		clearAll: "Tøm",
		total: (num) => `Totalt ${num} element`,
		selected: (num) => `${num} element valt`
	},
	...
	DynamicTags: { add: "Legg til" },
	Log: { loading: "Lastar" },
	Input: { placeholder: "Fyll ut" },
	InputNumber: { placeholder: "Fyll ut" },
	DynamicInput: { create: "Opprett" },
	ThemeEditor: {
		title: "Temaredigerar",
