//#region src/locales/common/amET.ts
const amET = {
	name: "am-ET",
	global: {
		undo: "ቀልብስ",
	...
	Cascader: {
		...
		loading: "በመጫን ላይ",
		loadingRequiredMessage: (label) => `ከመምረጥዎ በፊት የ${label}ን ሁሉንም ልጆች ይጫኑ።`
	},
	Time: {
	...
	Transfer: {
		...
		clearAll: "አጽዳ",
		total: (num) => `በጠቅላላ ${num} ንጥሎች`,
		selected: (num) => `${num} ንጥሎች ተመርጠዋል`
	},
	Empty: { description: "መረጃ የለም" },
	Select: { placeholder: "እባክዎ ይምረጡ" },
	TimePicker: {
	...
	DynamicTags: { add: "ጨምር" },
	Log: { loading: "በመጫን ላይ" },
	Input: { placeholder: "እባክዎ ያስገቡ" },
	InputNumber: { placeholder: "እባክዎ ያስገቡ" },
	DynamicInput: { create: "ፍጠር" },
	ThemeEditor: {
		title: "የገጽታ አርታኢ",
