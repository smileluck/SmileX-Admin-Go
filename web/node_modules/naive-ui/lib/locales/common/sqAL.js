//#region src/locales/common/sqAL.ts
const sqAL = {
	name: "sq-AL",
	global: {
		undo: "Zhbëj",
	...
	Cascader: {
		...
		loadingRequiredMessage: (label) => `Ngarkoni të gjithë pasardhësit e ${label} para se ta zgjidhni.`
	},
	Time: {
	...
	Transfer: {
		...
		clearAll: "Pastro",
		total: (num) => `Gjithsej ${num} elemente`,
		selected: (num) => `${num} elemente të zgjedhura`
	},
	Empty: { description: "Nuk ka të dhëna" },
	Select: { placeholder: "Ju lutemi zgjidhni" },
	TimePicker: {
	...
	DynamicTags: { add: "Shto" },
	Log: { loading: "Duke u ngarkuar" },
	Input: { placeholder: "Ju lutemi shkruani" },
	InputNumber: { placeholder: "Ju lutemi shkruani" },
	DynamicInput: { create: "Krijo" },
	ThemeEditor: {
