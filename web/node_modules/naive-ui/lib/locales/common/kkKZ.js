//#region src/locales/common/kkKZ.ts
const kkKZ = {
	name: "kk-KZ",
	global: {
		undo: "Болдырмау",
	...
	Cascader: {
		...
		loading: "Жүктелуде",
		loadingRequiredMessage: (label) => `${label} барлық еншілерін белгілеуден бұрын жүктеңіз.`
	},
	Time: {
	...
	Transfer: {
		...
		clearAll: "Тазалау",
		total: (num) => `Барлығы ${num} элемент`,
		selected: (num) => `${num} элемент таңдалды`
	},
	Empty: { description: "Дерек жоқ" },
	Select: { placeholder: "Таңдаңыз" },
	TimePicker: {
	...
	DynamicTags: { add: "Қосу" },
	Log: { loading: "Жүктелуде" },
	Input: { placeholder: "Енгізіңіз" },
	InputNumber: { placeholder: "Енгізіңіз" },
	DynamicInput: { create: "Жасау" },
	ThemeEditor: {
