//#region src/locales/common/hyAM.ts
const hyAM = {
	name: "hy-AM",
	global: {
		undo: "Հետարկել",
	...
	Cascader: {
		...
		loading: "Բեռնում",
		loadingRequiredMessage: (label) => `Ընտրելուց առաջ բեռնեք ${label}-ի բոլոր ժառանգներին։`
	},
	Time: {
	...
	Transfer: {
		...
		clearAll: "Մաքրել",
		total: (num) => `Ընդամենը ${num} տարր`,
		selected: (num) => `Ընտրված է ${num} տարր`
	},
	Empty: { description: "Տվյալներ չկան" },
	Select: { placeholder: "Խնդրում ենք ընտրել" },
	TimePicker: {
	...
	DynamicTags: { add: "Ավելացնել" },
	Log: { loading: "Բեռնում" },
	Input: { placeholder: "Խնդրում ենք մուտքագրել" },
	InputNumber: { placeholder: "Խնդրում ենք մուտքագրել" },
	DynamicInput: { create: "Ստեղծել" },
	ThemeEditor: {
