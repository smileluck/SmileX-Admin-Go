//#region src/locales/common/hiIN.ts
const hiIN = {
	name: "hi-IN",
	global: {
		undo: "पूर्ववत करें",
	...
	Cascader: {
		...
		loadingRequiredMessage: (label) => `कृपया जाँचने से पहले ${label} के सभी वंशजों को लोड करें।`
	},
	Time: {
	...
	Transfer: {
		...
		clearAll: "साफ़ करें",
		total: (num) => `कुल ${num} आइटम`,
		selected: (num) => `${num} आइटम चयनित`
	},
	Empty: { description: "कोई डेटा नहीं" },
	Select: { placeholder: "कृपया चुनें" },
	TimePicker: {
	...
	DynamicTags: { add: "जोड़ें" },
	Log: { loading: "लोड हो रहा है" },
	Input: { placeholder: "कृपया दर्ज करें" },
	InputNumber: { placeholder: "कृपया दर्ज करें" },
	DynamicInput: { create: "बनाएँ" },
	ThemeEditor: {
		title: "थीम संपादक",
