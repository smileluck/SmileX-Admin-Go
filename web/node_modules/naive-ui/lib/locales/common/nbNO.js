//#region src/locales/common/nbNO.ts
const nbNO = {
	name: "nb-NO",
	global: {
		undo: "Angre",
	...
	Transfer: {
		...
		clearAll: "Tøm",
		total: (num) => `Totalt ${num} elementer`,
		selected: (num) => `${num} elementer valgt`
	},
	Empty: { description: "Ingen data" },
	Select: { placeholder: "Vennligst velg" },
	TimePicker: {
	...
	Log: { loading: "Laster" },
	Input: { placeholder: "Vennligst fyll ut" },
	InputNumber: { placeholder: "Vennligst fyll ut" },
