//#region src/locales/common/faIR.ts
const faIR = {
	name: "fa-IR",
	global: {
		undo: "لغو انجام شده",
	...
	Empty: { description: "اطلاعاتی وجود ندارد" },
	Select: { placeholder: "لطفاً انتخاب کنید" },
	TimePicker: {
	...
	DynamicTags: { add: "افزودن" },
	Log: { loading: "در حال بارگذاری" },
	Input: { placeholder: "لطفاً وارد کنید" },
	InputNumber: { placeholder: "لطفاً وارد کنید" },
	DynamicInput: { create: "افزودن" },
	ThemeEditor: {
