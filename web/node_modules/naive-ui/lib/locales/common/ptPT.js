//#region src/locales/common/ptPT.ts
const ptPT = {
	name: "pt-PT",
	global: {
		undo: "Anular",
	...
	Cascader: {
		...
		loading: "A carregar",
		loadingRequiredMessage: (label) => `Carregue todos os descendentes de ${label} antes de o selecionar.`
	},
	Time: {
