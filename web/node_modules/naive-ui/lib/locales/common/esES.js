//#region src/locales/common/esES.ts
const esES = {
	name: "es-ES",
	global: {
		undo: "Deshacer",
	...
	Cascader: {
		...
		loading: "Cargando",
		loadingRequiredMessage: (label) => `Cargue todos los descendientes de ${label} antes de seleccionarlo.`
	},
	Time: {
	...
	DynamicTags: { add: "Añadir" },
	Log: { loading: "Cargando" },
	Input: { placeholder: "Introduzca" },
	InputNumber: { placeholder: "Introduzca" },
