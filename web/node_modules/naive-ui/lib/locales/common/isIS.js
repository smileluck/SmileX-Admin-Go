//#region src/locales/common/isIS.ts
const isIS = {
	name: "is-IS",
	global: {
		undo: "Afturkalla",
	...
	Cascader: {
		...
		loading: "Hleð",
		loadingRequiredMessage: (label) => `Hladdu öllum afkomendum ${label} áður en þú velur.`
	},
	Time: {
		dateFormat: "d.M.yyyy",
	...
	Transfer: {
		...
		clearAll: "Hreinsa",
		total: (num) => `Samtals ${num} atriði`,
		selected: (num) => `${num} atriði valin`
	},
	Empty: { description: "Engin gögn" },
	Select: { placeholder: "Vinsamlegast veldu" },
	TimePicker: {
	...
	DynamicTags: { add: "Bæta við" },
	Log: { loading: "Hleð" },
	Input: { placeholder: "Vinsamlegast sláðu inn" },
	InputNumber: { placeholder: "Vinsamlegast sláðu inn" },
	DynamicInput: { create: "Búa til" },
	ThemeEditor: {
