//#region src/locales/common/svSE.ts
const svSE = {
	name: "sv-SE",
	global: {
		undo: "Ångra",
	...
	Select: { placeholder: "Vänligen välj" },
	TimePicker: {
	...
	DynamicTags: { add: "Lägg till" },
	Log: { loading: "Laddar" },
	Input: { placeholder: "Vänligen fyll i" },
	InputNumber: { placeholder: "Vänligen fyll i" },
	DynamicInput: { create: "Skapa" },
	ThemeEditor: {
		title: "Temaverktyg",
