//#region src/locales/common/guIN.ts
const guIN = {
	name: "gu-IN",
	global: {
		undo: "પૂર્વવત કરો",
	...
	Cascader: {
		...
		loadingRequiredMessage: (label) => `કૃપા કરીને તપાસતા પહેલાં ${label}ના બધા વંશજો લોડ કરો.`
	},
	Time: {
	...
	Transfer: {
		...
		clearAll: "સાફ કરો",
		total: (num) => `કુલ ${num} આઇટમ`,
		selected: (num) => `${num} આઇટમ પસંદ થયેલ`
	},
	Empty: { description: "કોઈ ડેટા નથી" },
	Select: { placeholder: "કૃપા કરીને પસંદ કરો" },
	TimePicker: {
	...
	DynamicTags: { add: "ઉમેરો" },
	Log: { loading: "લોડ થઈ રહ્યું છે" },
	Input: { placeholder: "કૃપા કરીને દાખલ કરો" },
	InputNumber: { placeholder: "કૃપા કરીને દાખલ કરો" },
	DynamicInput: { create: "બનાવો" },
	ThemeEditor: {
		title: "થીમ સંપાદક",
