//#region src/locales/common/idID.ts
const idID = {
	name: "id-ID",
	global: {
		undo: "Membatalkan",
	...
	Select: { placeholder: "Mohon Pilih" },
	TimePicker: {
	...
	Log: { loading: "Memuat" },
	Input: { placeholder: "Mohon isi" },
	InputNumber: { placeholder: "Mohon isi" },
	DynamicInput: { create: "Buat baru" },
	ThemeEditor: {
