//#region src/locales/common/kmKH.ts
const kmKH = {
	name: "km-KH",
	global: {
		undo: "បោះបង់",
	...
	DynamicTags: { add: "បន្ថែមទៅ" },
	Log: { loading: "ការផ្ទុក" },
	Input: { placeholder: "សូមបញ្ចូល" },
	InputNumber: { placeholder: "សូមបញ្ចូល" },
	DynamicInput: { create: "បន្ថែមទៅ" },
	ThemeEditor: {
