//#region src/locales/common/srRS.ts
const srRS = {
	name: "sr-RS",
	global: {
		undo: "Опозови",
	...
	Cascader: {
		...
		loading: "Учитавање",
		loadingRequiredMessage: (label) => `Учитајте све потомке ставке ${label} пре избора.`
	},
	Time: {
	...
	Transfer: {
		...
		clearAll: "Очисти",
		total: (num) => `Укупно ${num} ставки`,
		selected: (num) => `Изабрано ${num} ставки`
	},
	Empty: { description: "Нема података" },
	Select: { placeholder: "Изаберите" },
	TimePicker: {
	...
	DynamicTags: { add: "Додај" },
	Log: { loading: "Учитавање" },
	Input: { placeholder: "Унесите" },
	InputNumber: { placeholder: "Унесите" },
	DynamicInput: { create: "Направи" },
	ThemeEditor: {
		title: "Уређивач теме",
