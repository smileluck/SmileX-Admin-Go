//#region src/locales/common/slSI.ts
const slSI = {
	name: "sl-SI",
	global: {
		undo: "Razveljavi",
	...
	Cascader: {
		...
		loading: "Nalaganje",
		loadingRequiredMessage: (label) => `Pred izbiro naložite vse potomce elementa ${label}.`
	},
	Time: {
		dateFormat: "d. M. yyyy",
	...
	Transfer: {
		...
		clearAll: "Počisti",
		total: (num) => `Skupaj ${num} elementov`,
		selected: (num) => `Izbranih ${num} elementov`
	},
	...
	Log: { loading: "Nalaganje" },
	Input: { placeholder: "Vnesite" },
	InputNumber: { placeholder: "Vnesite" },
	DynamicInput: { create: "Ustvari" },
	ThemeEditor: {
