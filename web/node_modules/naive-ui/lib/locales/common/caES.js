//#region src/locales/common/caES.ts
const caES = {
	name: "ca-ES",
	global: {
		undo: "Desfer",
	...
	Cascader: {
		...
		loadingRequiredMessage: (label) => `Carregueu tots els descendents de ${label} abans de seleccionar-lo.`
	},
	Time: {
	...
	Transfer: {
		...
		selected: (num) => `${num} elements seleccionats`
	},
	Empty: { description: "Sense dades" },
	Select: { placeholder: "Seleccioneu" },
	TimePicker: {
	...
	DynamicTags: { add: "Afegir" },
	Log: { loading: "S'està carregant" },
	Input: { placeholder: "Introduïu" },
	InputNumber: { placeholder: "Introduïu" },
