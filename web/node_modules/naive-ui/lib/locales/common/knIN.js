//#region src/locales/common/knIN.ts
const knIN = {
	name: "kn-IN",
	global: {
		undo: "ಹಿಂಪಡೆಯಿರಿ",
	...
	Cascader: {
		...
		loadingRequiredMessage: (label) => `ಪರಿಶೀಲಿಸುವ ಮೊದಲು ${label} ನ ಎಲ್ಲಾ ವಂಶಜರನ್ನು ಲೋಡ್ ಮಾಡಿ.`
	},
	Time: {
	...
	Transfer: {
		...
		total: (num) => `ಒಟ್ಟು ${num} ಐಟಂಗಳು`,
		selected: (num) => `${num} ಐಟಂಗಳು ಆಯ್ಕೆಯಾಗಿವೆ`
	},
	Empty: { description: "ಡೇಟಾ ಇಲ್ಲ" },
	Select: { placeholder: "ದಯವಿಟ್ಟು ಆಯ್ಕೆಮಾಡಿ" },
	TimePicker: {
	...
	DynamicTags: { add: "ಸೇರಿಸಿ" },
	Log: { loading: "ಲೋಡ್ ಆಗುತ್ತಿದೆ" },
	Input: { placeholder: "ದಯವಿಟ್ಟು ನಮೂದಿಸಿ" },
	InputNumber: { placeholder: "ದಯವಿಟ್ಟು ನಮೂದಿಸಿ" },
	DynamicInput: { create: "ರಚಿಸಿ" },
	ThemeEditor: {
		title: "ಥೀಮ್ ಸಂಪಾದಕ",
