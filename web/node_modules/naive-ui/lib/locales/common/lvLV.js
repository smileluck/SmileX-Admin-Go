//#region src/locales/common/lvLV.ts
const lvLV = {
	name: "lv-LV",
	global: {
		undo: "Atsaukt",
	...
	Cascader: {
		...
		loading: "Ielādē",
		loadingRequiredMessage: (label) => `Pirms atlases ielādējiet visus ${label} pēctečus.`
	},
	Time: {
	...
	Transfer: {
		...
		clearAll: "Notīrīt",
		total: (num) => `Kopā ${num} vienumi`,
		selected: (num) => `Atlasīti ${num} vienumi`
	},
	Empty: { description: "Nav datu" },
	Select: { placeholder: "Lūdzu, atlasiet" },
	TimePicker: {
	...
	DynamicTags: { add: "Pievienot" },
	Log: { loading: "Ielādē" },
	Input: { placeholder: "Lūdzu, ievadiet" },
	InputNumber: { placeholder: "Lūdzu, ievadiet" },
	DynamicInput: { create: "Izveidot" },
	ThemeEditor: {
