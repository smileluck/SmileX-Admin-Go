//#region src/locales/common/rmCH.ts
const rmCH = {
	name: "rm-CH",
	global: {
		undo: "Distornar",
	...
	Cascader: {
		...
		loading: "Chargiar",
		loadingRequiredMessage: (label) => `Chargiai tut ils descendents da ${label} avant da tscherner.`
	},
	Time: {
	...
	Transfer: {
		...
		clearAll: "Stizzar",
		total: (num) => `Total ${num} elements`,
		selected: (num) => `${num} elements tschernids`
	},
	Empty: { description: "Naginas datas" },
	Select: { placeholder: "Tscherni per plaschair" },
	TimePicker: {
	...
	DynamicTags: { add: "Agiuntar" },
	Log: { loading: "Chargiar" },
	Input: { placeholder: "Endatai per plaschair" },
	InputNumber: { placeholder: "Endatai per plaschair" },
