//#region src/locales/common/nlNL.ts
const nlNL = {
	name: "nl-NL",
	global: {
		undo: "Ongedaan Maken",
	...
	Select: { placeholder: "Selecteer a.u.b." },
	TimePicker: {
	...
	DynamicTags: { add: "Toevoegen" },
	Log: { loading: "Laden" },
	Input: { placeholder: "Invoeren a.u.b." },
	InputNumber: { placeholder: "Invoeren a.u.b." },
	DynamicInput: { create: "Creëer" },
	ThemeEditor: {
