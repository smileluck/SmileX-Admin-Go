...
const fiFI = {
	...
	Empty: { description: "Ei tietoja" },
	Select: { placeholder: "Valitse" },
	TimePicker: {
	...
	DynamicTags: { add: "Lisää" },
	Log: { loading: "Ladataan" },
	Input: { placeholder: "Kirjoita" },
	InputNumber: { placeholder: "Kirjoita" },
	DynamicInput: { create: "Luo" },
	ThemeEditor: {
		title: "Teemaeditori",
