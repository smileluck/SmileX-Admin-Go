//#region src/locales/common/mnMN.ts
const mnMN = {
	name: "mn-MN",
	global: {
		undo: "Буцаах",
	...
	Cascader: {
		...
		loadingRequiredMessage: (label) => `${label}-н бүх дэд зүйлийг сонгохоосоо өмнө ачаална уу.`
	},
	Time: {
	...
	Transfer: {
		...
		clearAll: "Цэвэрлэх",
		total: (num) => `Нийт ${num} зүйл`,
		selected: (num) => `${num} зүйл сонгосон`
	},
	Empty: { description: "Өгөгдөл байхгүй" },
	...
	DynamicTags: { add: "Нэмэх" },
	Log: { loading: "Ачаалж байна" },
	Input: { placeholder: "Оруулна уу" },
	InputNumber: { placeholder: "Оруулна уу" },
	DynamicInput: { create: "Үүсгэх" },
	ThemeEditor: {
