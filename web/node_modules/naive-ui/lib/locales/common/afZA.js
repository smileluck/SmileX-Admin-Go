//#region src/locales/common/afZA.ts
const afZA = {
	name: "af-ZA",
	global: {
		undo: "Ontdoen",
	...
	Cascader: {
		...
		loading: "Laai tans",
		loadingRequiredMessage: (label) => `Laai asseblief al ${label} se afstammelinge voordat u dit kies.`
	},
	Time: {
	...
	Transfer: {
		...
		clearAll: "Maak skoon",
		total: (num) => `Totaal ${num} items`,
		selected: (num) => `${num} items gekies`
	},
	Empty: { description: "Geen data" },
	Select: { placeholder: "Kies asseblief" },
	TimePicker: {
	...
	DynamicTags: { add: "Voeg by" },
	Log: { loading: "Laai tans" },
	Input: { placeholder: "Voer asseblief in" },
	InputNumber: { placeholder: "Voer asseblief in" },
	DynamicInput: { create: "Skep" },
	ThemeEditor: {
