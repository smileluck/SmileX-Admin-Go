//#region src/locales/common/kaGE.ts
const kaGE = {
	name: "ka-GE",
	global: {
		undo: "გაუქმება",
	...
	Cascader: {
		...
		loading: "იტვირთება",
		loadingRequiredMessage: (label) => `არჩევამდე ჩატვირთეთ ${label}-ის ყველა შთამომავალი.`
	},
	Time: {
	...
	Transfer: {
		...
		total: (num) => `სულ ${num} ელემენტი`,
		selected: (num) => `არჩეულია ${num} ელემენტი`
	},
	Empty: { description: "მონაცემები არ არის" },
	Select: { placeholder: "გთხოვთ აირჩიოთ" },
	TimePicker: {
	...
	DynamicTags: { add: "დამატება" },
	Log: { loading: "იტვირთება" },
	Input: { placeholder: "გთხოვთ შეიყვანოთ" },
	InputNumber: { placeholder: "გთხოვთ შეიყვანოთ" },
	DynamicInput: { create: "შექმნა" },
	ThemeEditor: {
