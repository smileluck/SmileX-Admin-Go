//#region src/locales/common/filPH.ts
const filPH = {
	name: "fil-PH",
	global: {
		undo: "I-undo",
	...
	Cascader: {
		...
		loading: "Naglo-load",
		loadingRequiredMessage: (label) => `I-load muna ang lahat ng descendant ng ${label} bago ito piliin.`
	},
	Time: {
	...
	Transfer: {
		...
		clearAll: "I-clear",
		total: (num) => `Kabuuan ${num} item`,
		selected: (num) => `${num} item ang napili`
	},
	Empty: { description: "Walang data" },
	Select: { placeholder: "Mangyaring pumili" },
	TimePicker: {
	...
	DynamicTags: { add: "Idagdag" },
	Log: { loading: "Naglo-load" },
	Input: { placeholder: "Mangyaring maglagay" },
	InputNumber: { placeholder: "Mangyaring maglagay" },
	DynamicInput: { create: "Lumikha" },
	ThemeEditor: {
		title: "Theme Editor",
