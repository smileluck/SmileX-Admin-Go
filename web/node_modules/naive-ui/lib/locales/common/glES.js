//#region src/locales/common/glES.ts
const glES = {
	name: "gl-ES",
	global: {
		undo: "Desfacer",
	...
	Cascader: {
		...
		loading: "Cargando",
		loadingRequiredMessage: (label) => `Cargue todos os descendentes de ${label} antes de seleccionalo.`
	},
	Time: {
	...
	Transfer: {
		...
		clearAll: "Borrar",
		total: (num) => `Total ${num} elementos`,
		selected: (num) => `${num} elementos seleccionados`
	},
	Empty: { description: "Sen datos" },
	...
	DynamicTags: { add: "Engadir" },
	Log: { loading: "Cargando" },
	Input: { placeholder: "Introduza" },
	InputNumber: { placeholder: "Introduza" },
