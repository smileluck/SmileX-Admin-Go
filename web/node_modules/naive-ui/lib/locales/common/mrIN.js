//#region src/locales/common/mrIN.ts
const mrIN = {
	name: "mr-IN",
	global: {
		undo: "पूर्ववत करा",
	...
	Cascader: {
		...
		loading: "लोड होत आहे",
		loadingRequiredMessage: (label) => `कृपया तपासण्यापूर्वी ${label}चे सर्व वंशज लोड करा.`
	},
	Time: {
	...
	Transfer: {
		...
		clearAll: "साफ करा",
		total: (num) => `एकूण ${num} आयटम`,
		selected: (num) => `${num} आयटम निवडले`
	},
	Empty: { description: "डेटा नाही" },
	Select: { placeholder: "कृपया निवडा" },
	TimePicker: {
	...
	DynamicTags: { add: "जोडा" },
	Log: { loading: "लोड होत आहे" },
	Input: { placeholder: "कृपया प्रविष्ट करा" },
	InputNumber: { placeholder: "कृपया प्रविष्ट करा" },
	DynamicInput: { create: "तयार करा" },
	ThemeEditor: {
		title: "थीम संपादक",
