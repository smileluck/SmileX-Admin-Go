//#region src/locales/common/kyKG.ts
const kyKG = {
	name: "ky-KG",
	global: {
		undo: "Жокко чыгаруу",
	...
	Cascader: {
		...
		loading: "Жүктөлүүдө",
		loadingRequiredMessage: (label) => `${label} бардык тукумдарын тандоодон мурун жүктөңүз.`
	},
	Time: {
	...
	Transfer: {
		...
		clearAll: "Тазалоо",
		total: (num) => `Жалпы ${num} элемент`,
		selected: (num) => `${num} элемент тандалды`
	},
	Empty: { description: "Маалымат жок" },
	Select: { placeholder: "Тандаңыз" },
	TimePicker: {
	...
	DynamicTags: { add: "Кошуу" },
	Log: { loading: "Жүктөлүүдө" },
	Input: { placeholder: "Киргизиңиз" },
	InputNumber: { placeholder: "Киргизиңиз" },
	DynamicInput: { create: "Түзүү" },
	ThemeEditor: {
