//#region src/locales/common/hrHR.ts
const hrHR = {
	name: "hr-HR",
	global: {
		undo: "Poništi",
	...
	Cascader: {
		...
		loading: "Učitavanje",
		loadingRequiredMessage: (label) => `Učitajte sve potomke stavke ${label} prije odabira.`
	},
	Time: {
	...
	Transfer: {
		...
		clearAll: "Očisti",
		total: (num) => `Ukupno ${num} stavki`,
		selected: (num) => `Odabrano ${num} stavki`
	},
	Empty: { description: "Nema podataka" },
	Select: { placeholder: "Odaberite" },
	TimePicker: {
	...
	DynamicTags: { add: "Dodaj" },
	Log: { loading: "Učitavanje" },
	Input: { placeholder: "Unesite" },
	InputNumber: { placeholder: "Unesite" },
	DynamicInput: { create: "Stvori" },
	ThemeEditor: {
		title: "Uređivač teme",
