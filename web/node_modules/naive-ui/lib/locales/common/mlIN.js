//#region src/locales/common/mlIN.ts
const mlIN = {
	name: "ml-IN",
	global: {
		undo: "പഴയപടിയാക്കുക",
	...
	Cascader: {
		...
		loadingRequiredMessage: (label) => `പരിശോധിക്കുന്നതിന് മുമ്പ് ${label} ന്റെ എല്ലാ സന്തതികളെയും ലೋಡ് ചെയ്യുക.`
	},
	Time: {
	...
	Transfer: {
		...
		clearAll: "മായ്ക്കുക",
		total: (num) => `ആകെ ${num} ഇനങ്ങൾ`,
		selected: (num) => `${num} ഇനങ്ങൾ തിരഞ്ഞെടുത്തു`
	},
	Empty: { description: "ഡാറ്റയില്ല" },
	Select: { placeholder: "ദയവായി തിരഞ്ഞെടുക്കുക" },
	TimePicker: {
	...
	DynamicTags: { add: "ചേർക്കുക" },
	Log: { loading: "ലോഡ് ചെയ്യുന്നു" },
	Input: { placeholder: "ദയവായി നൽകുക" },
	InputNumber: { placeholder: "ദയവായി നൽകുക" },
	DynamicInput: { create: "സൃഷ്ടിക്കുക" },
	ThemeEditor: {
		title: "തീം എഡിറ്റർ",
