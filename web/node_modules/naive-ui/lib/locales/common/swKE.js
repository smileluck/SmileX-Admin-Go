//#region src/locales/common/swKE.ts
const swKE = {
	name: "sw-KE",
	global: {
		undo: "Tendua",
	...
	Cascader: {
		...
		loading: "Inapakia",
		loadingRequiredMessage: (label) => `Tafadhali pakia vizazi vyote vya ${label} kabla ya kukichagua.`
	},
	Time: {
	...
	Transfer: {
		...
		clearAll: "Futa",
		total: (num) => `Jumla ya vipengee ${num}`,
		selected: (num) => `Vipengee ${num} vimechaguliwa`
	},
	Empty: { description: "Hakuna data" },
	Select: { placeholder: "Tafadhali chagua" },
	TimePicker: {
	...
	DynamicTags: { add: "Ongeza" },
	Log: { loading: "Inapakia" },
	Input: { placeholder: "Tafadhali ingiza" },
	InputNumber: { placeholder: "Tafadhali ingiza" },
	DynamicInput: { create: "Unda" },
	ThemeEditor: {
