//#region src/locales/common/itIT.ts
const itIT = {
	name: "it-IT",
	global: {
		undo: "Annulla",
	...
	Select: { placeholder: "Si prega di selezionare" },
	TimePicker: {
	...
	DynamicTags: { add: "Aggiungi" },
	Log: { loading: "Caricamento" },
	Input: { placeholder: "Si prega di inserire" },
	InputNumber: { placeholder: "Si prega di inserire" },
	DynamicInput: { create: "Crea" },
	ThemeEditor: {
		title: "Editor Tema",
