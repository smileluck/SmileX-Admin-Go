//#region src/locales/common/taIN.ts
const taIN = {
	name: "ta-IN",
	global: {
		undo: "செயல்தவிர்",
	...
	Cascader: {
		...
		loading: "ஏற்றுகிறது",
		loadingRequiredMessage: (label) => `சரிபார்ப்பதற்கு முன் ${label} இன் அனைத்து வழித்தோன்றல்களையும் ஏற்றவும்.`
	},
	Time: {
	...
	Transfer: {
		...
		clearAll: "அழி",
		total: (num) => `மொத்தம் ${num} உருப்படிகள்`,
		selected: (num) => `${num} உருப்படிகள் தேர்ந்தெடுக்கப்பட்டன`
	},
	Empty: { description: "தரவு இல்லை" },
	Select: { placeholder: "தயவுசெய்து தேர்ந்தெடுக்கவும்" },
	TimePicker: {
	...
	DynamicTags: { add: "சேர்" },
	Log: { loading: "ஏற்றுகிறது" },
	Input: { placeholder: "தயவுசெய்து உள்ளிடவும்" },
	InputNumber: { placeholder: "தயவுசெய்து உள்ளிடவும்" },
	DynamicInput: { create: "உருவாக்கு" },
	ThemeEditor: {
