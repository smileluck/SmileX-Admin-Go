//#region src/locales/common/skSK.ts
const skSK = {
	name: "sk-SK",
	global: {
		undo: "Späť",
	...
	Select: { placeholder: "Prosím vyberte" },
	TimePicker: {
	...
	DynamicTags: { add: "Pridať" },
	Log: { loading: "Načítavanie" },
	Input: { placeholder: "Zadajte" },
	InputNumber: { placeholder: "Zadajte" },
	DynamicInput: { create: "Vytvoriť" },
	ThemeEditor: {
		title: "Editor tém",
