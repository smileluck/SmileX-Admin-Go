//#region src/locales/common/myMM.ts
const myMM = {
	name: "my-MM",
	global: {
		undo: "ပြာန်ဆုတ်",
	...
	Cascader: {
		...
		loading: "တိင်နေသည်",
		loadingRequiredMessage: (label) => `စိစ်စေးမည့်မီ ${label} ၏ အောက်အဆင့်အားလုံးကို တိင်ပာ`
	},
	Time: {
	...
	Transfer: {
		...
		total: (num) => `စုစုပောင်း ${num} ခု`,
		selected: (num) => `${num} ခု ရွေးထားသည်`
	},
	Empty: { description: "ဒေတာမရှိပာ" },
	Select: { placeholder: "ကြေးဇူပြု၍ ရွေးချယ်ပာ" },
	TimePicker: {
	...
	DynamicTags: { add: "ထည့်ပာ" },
	Log: { loading: "တိင်နေသည်" },
	Input: { placeholder: "ကြေးဇူပြု၍ ရိုက်ထည့်ပာ" },
	InputNumber: { placeholder: "ကြေးဇူပြု၍ ရိုက်ထည့်ပာ" },
	DynamicInput: { create: "ဖန်တီးပာ" },
	ThemeEditor: {
