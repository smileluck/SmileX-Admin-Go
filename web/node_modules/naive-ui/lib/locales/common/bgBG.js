//#region src/locales/common/bgBG.ts
const bgBG = {
	name: "bg-BG",
	global: {
		undo: "Отмени",
	...
	Cascader: {
		...
		loading: "Зареждане",
		loadingRequiredMessage: (label) => `Моля, заредете всички наследници на ${label} преди да го изберете.`
	},
	Time: {
	...
	Transfer: {
		...
		clearAll: "Изчисти",
		total: (num) => `Общо ${num} елемента`,
		selected: (num) => `Избрани ${num} елемента`
	},
	Empty: { description: "Няма данни" },
	Select: { placeholder: "Моля, изберете" },
	TimePicker: {
	...
	DynamicTags: { add: "Добави" },
	Log: { loading: "Зареждане" },
	Input: { placeholder: "Моля, въведете" },
	InputNumber: { placeholder: "Моля, въведете" },
	DynamicInput: { create: "Създай" },
	ThemeEditor: {
