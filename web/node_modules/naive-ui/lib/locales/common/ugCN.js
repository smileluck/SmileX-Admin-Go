//#region src/locales/common/ugCN.ts
const ugCN = {
	name: "ug-CN",
	global: {
		undo: "قالدۇرۇش",
	...
	Empty: { description: "ئۇچۇر يوق" },
	Select: { placeholder: "تاللاڭ" },
	TimePicker: {
	...
	DynamicTags: { add: "قوشۇش" },
	Log: { loading: "يۈكلەۋاتىدۇ" },
	Input: { placeholder: "كىرگۈزۈڭ" },
	InputNumber: { placeholder: "كىرگۈزۈڭ" },
	DynamicInput: { create: "قوشۇش" },
	ThemeEditor: {
