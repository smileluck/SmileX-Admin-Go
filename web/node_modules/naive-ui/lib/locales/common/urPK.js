//#region src/locales/common/urPK.ts
const urPK = {
	name: "ur-PK",
	global: {
		undo: "کالعدم",
	...
	Cascader: {
		...
		loadingRequiredMessage: (label) => `براہ کرم نشان زد کرنے سے پہلے ${label} کی تمام ذیلی شاخیں لوڈ کریں۔`
	},
	Time: {
	...
	Transfer: {
		...
		clearAll: "صاف کریں",
		total: (num) => `کل ${num} آئٹمز`,
		selected: (num) => `${num} آئٹمز منتخب`
	},
	Empty: { description: "کوئی ڈیٹا نہیں" },
	Select: { placeholder: "براہ کرم منتخب کریں" },
	TimePicker: {
	...
	DynamicTags: { add: "شامل کریں" },
	Log: { loading: "لوڈ ہو رہا ہے" },
	Input: { placeholder: "براہ کرم درج کریں" },
	InputNumber: { placeholder: "براہ کرم درج کریں" },
	DynamicInput: { create: "بنائیں" },
	ThemeEditor: {
		title: "تھیم ایڈیٹر",
