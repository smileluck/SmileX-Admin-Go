//#region src/locales/common/siLK.ts
const siLK = {
	name: "si-LK",
	global: {
		undo: "අහෝසි කරන්න",
	...
	Cascader: {
		...
		loadingRequiredMessage: (label) => `කරුණාකර එය සලකුණු කිරීමට පෙර ${label} හි සියලු පරම්පරාවන් පූරණය කරන්න.`
	},
	Time: {
	...
	Transfer: {
		...
		clearAll: "හිස් කරන්න",
		total: (num) => `මුළු ${num} අයිතම`,
		selected: (num) => `${num} අයිතම තෝරා ඇත`
	},
	Empty: { description: "දත්ත නැත" },
	Select: { placeholder: "කරුණාකර තෝරන්න" },
	TimePicker: {
	...
	DynamicTags: { add: "එක් කරන්න" },
	Log: { loading: "පූරණය වෙමින්" },
	Input: { placeholder: "කරුණාකර ඇතුළත් කරන්න" },
	InputNumber: { placeholder: "කරුණාකර ඇතුළත් කරන්න" },
	DynamicInput: { create: "සාදන්න" },
	ThemeEditor: {
