//#region src/locales/common/beBY.ts
const beBY = {
	name: "be-BY",
	global: {
		undo: "Адмяніць",
	...
	Cascader: {
		...
		loading: "Загрузка",
		loadingRequiredMessage: (label) => `Загрузіце ўсе нашчадкі ${label} перад выбарам.`
	},
	Time: {
	...
	Transfer: {
		...
		clearAll: "Ачысціць",
		total: (num) => `Усяго ${num} элементаў`,
		selected: (num) => `Выбрана ${num} элементаў`
	},
	Empty: { description: "Няма даных" },
	Select: { placeholder: "Калі ласка, выберыце" },
	TimePicker: {
	...
	DynamicTags: { add: "Дадаць" },
	Log: { loading: "Загрузка" },
	Input: { placeholder: "Калі ласка, увядзіце" },
	InputNumber: { placeholder: "Калі ласка, увядзіце" },
	DynamicInput: { create: "Стварыць" },
	ThemeEditor: {
		title: "Рэдактар тэмы",
