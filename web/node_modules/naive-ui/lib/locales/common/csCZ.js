//#region src/locales/common/csCZ.ts
const csCZ = {
	name: "cs-CZ",
	global: {
		undo: "Zpět",
	...
	DynamicTags: { add: "Přidat" },
	Log: { loading: "Načítání" },
	Input: { placeholder: "Zadejte" },
	InputNumber: { placeholder: "Zadejte" },
	DynamicInput: { create: "Vytvořit" },
	ThemeEditor: {
		title: "Editor témat",
