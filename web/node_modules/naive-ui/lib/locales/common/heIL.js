//#region src/locales/common/heIL.ts
const heIL = {
	name: "he-IL",
	global: {
		undo: "בטל",
	...
	Cascader: {
		...
		loading: "טוען",
		loadingRequiredMessage: (label) => `יש לטעון את כל הצאצאים של ${label} לפני הבחירה.`
	},
	Time: {
	...
	Transfer: {
		...
		clearAll: "נקה",
		total: (num) => `סה״כ ${num} פריטים`,
		selected: (num) => `נבחרו ${num} פריטים`
	},
	Empty: { description: "אין נתונים" },
	Select: { placeholder: "נא לבחור" },
	TimePicker: {
	...
	DynamicTags: { add: "הוסף" },
	Log: { loading: "טוען" },
	Input: { placeholder: "נא להזין" },
	InputNumber: { placeholder: "נא להזין" },
	DynamicInput: { create: "צור" },
	ThemeEditor: {
