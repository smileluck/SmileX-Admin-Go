//#region src/locales/common/mkMK.ts
const mkMK = {
	name: "mk-MK",
	global: {
		undo: "Врати",
	...
	Cascader: {
		...
		loading: "Се вчитува",
		loadingRequiredMessage: (label) => `Вчитајте ги сите потомци на ${label} пред да го изберете.`
	},
	Time: {
	...
	Transfer: {
		...
		clearAll: "Исчисти",
		total: (num) => `Вкупно ${num} ставки`,
		selected: (num) => `Избрани се ${num} ставки`
	},
	Empty: { description: "Нема податоци" },
	Select: { placeholder: "Изберете" },
	TimePicker: {
	...
	Log: { loading: "Се вчитува" },
	Input: { placeholder: "Внесете" },
	InputNumber: { placeholder: "Внесете" },
	DynamicInput: { create: "Создај" },
	ThemeEditor: {
