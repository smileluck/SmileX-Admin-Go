//#region src/locales/common/bnBD.ts
const bnBD = {
	name: "bn-BD",
	global: {
	...
	Cascader: {
		...
		loading: "লোড হচ্ছে",
		loadingRequiredMessage: (label) => `নির্বাচনের আগে ${label}-এর সব অন্তর্ভুক্ত আইটেম লোড করুন।`
	},
	Time: {
	...
	Transfer: {
		...
		clearAll: "মুছুন",
		total: (num) => `মোট ${num}টি আইটেম`,
		selected: (num) => `${num}টি আইটেম নির্বাচিত`
	},
	Empty: { description: "কোনো তথ্য নেই" },
	Select: { placeholder: "অনুগ্রহ করে নির্বাচন করুন" },
	TimePicker: {
	...
	DynamicTags: { add: "যোগ করুন" },
	Log: { loading: "লোড হচ্ছে" },
	Input: { placeholder: "অনুগ্রহ করে লিখুন" },
	InputNumber: { placeholder: "অনুগ্রহ করে লিখুন" },
	DynamicInput: { create: "তৈরি করুন" },
	ThemeEditor: {
		title: "থিম সম্পাদক",
