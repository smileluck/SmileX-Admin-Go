...
//#region src/_styles/common/dark.ts
const base = {
	neutralBase: "#000",
...
const derived = {
	...
	iconColorPressed: overlay(Number(base.alpha4) * .8),
	...
	clearColorHover: (0, seemly.scaleColor)(overlay(base.alpha4), { alpha: 1.25 }),
	clearColorPressed: (0, seemly.scaleColor)(overlay(base.alpha4), { alpha: .8 }),
