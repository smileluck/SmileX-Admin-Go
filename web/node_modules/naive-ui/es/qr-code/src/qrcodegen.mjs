//#region src/qr-code/src/qrcodegen.ts
let qrcodegen;
(function (_qrcodegen) {
  class QrCode {
    ...
    static encodeSegments(segs, ecl, minVersion = 1, maxVersion = 40, mask = -1, boostEcl = true) {
      ...
      for (const newEcl of [QrCode.Ecc.MEDIUM, QrCode.Ecc.QUARTILE, QrCode.Ecc.HIGH]) if (boostEcl && dataUsedBits <= QrCode.getNumDataCodewords(version, newEcl) * 8) ecl = newEcl;
      const bb = [];
  ...
  class QrSegment {
    ...
    static makeEci(assignVal) {
      const bb = [];
      if (assignVal < 0) throw new RangeError("ECI assignment value out of range");else if (assignVal < 128) appendBits(assignVal, 8, bb);else if (assignVal < 16384) {
        appendBits(2, 2, bb);
    ...
    static toUtf8ByteArray(str) {
      str = encodeURI(str);
      const result = [];
      for (let i = 0; i < str.length; i++) if (str.charAt(i) !== "%") result.push(str.charCodeAt(i));else {
...
//#endregion
export { qrcodegen_default as default };