...
//#region src/alert/styles/light.d.ts
...
interface AlertThemeVars extends ReturnType<typeof self> {}
declare const alertLight: AlertTheme;
interface AlertTheme extends Theme<'Alert', AlertThemeVars> {}
interface AlertThemeOverrides extends ExtractThemeOverrides<AlertTheme> {}
//#endregion
export { AlertTheme, AlertThemeOverrides, AlertThemeVars, alertLight as default };