...
var index_cssr_default = c([cB("data-table", `
 width: 100%;
 ...
 display: flex;
 flex-direction: column;
 `), cM("empty", [cB("data-table-base-table", `
 height: 100%;
 display: flex;
 flex-direction: column;
 `), cB("data-table-base-table-body", [`height: 100%;`, cB("scrollbar-content", `
 height: 100%;
 display: flex;
 flex-direction: column;
 ...
 flex-direction: column;
 flex-grow: 1;
 `, [c(">", [cB("data-table-base-table-body", "flex-basis: 0;", [c("&:last-child", "flex-grow: 1;")])])])])])])]), c(">", [cB("data-table-loading-wrapper", `
