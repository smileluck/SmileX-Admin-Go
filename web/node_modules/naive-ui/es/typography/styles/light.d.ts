...
//#region src/typography/styles/light.d.ts
...
interface TypographyThemeVars extends ReturnType<typeof self> {}
declare const typographyLight: TypographyTheme;
interface TypographyTheme extends Theme<'Typography', TypographyThemeVars> {}
interface TypographyThemeOverrides extends ExtractThemeOverrides<TypographyTheme> {}
//#endregion
export { TypographyTheme, TypographyThemeOverrides, TypographyThemeVars, typographyLight as default, self };