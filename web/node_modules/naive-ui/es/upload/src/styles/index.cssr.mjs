...
var index_cssr_default = c([cB("upload", "width: 100%;", [cM("dragger-inside", [cB("upload-trigger", `
 ...
 content: "";
 `), c("&:hover", [c("&::before", "opacity: 1;"), cB("upload-file-info", [cE("thumbnail", "opacity: .12;")])]), cM("always-show-actions", [c("&::before", "opacity: 1;"), cB("upload-file-info", [cE("thumbnail", "opacity: .12;")])])]), cM("error-status", [c("&:hover", `
