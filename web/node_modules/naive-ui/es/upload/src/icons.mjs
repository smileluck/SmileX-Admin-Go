...
//#region src/upload/src/icons.tsx
/**
...
function renderImageIcon() {
  return (() => {
    const _cache = createVNodeCache("39989d0be5c9bff7");
...
function renderDocumentIcon() {
  return (() => {
    const _cache = createVNodeCache("c8e04259929228b8");
    return _cache[0] || (_cache[0] = createElementVNode("svg", {
      xmlns: "http://www.w3.org/2000/svg",
      viewBox: "0 0 28 28"
    }, [createElementVNode("g", {
...
//#endregion
export { renderDocumentIcon, renderImageIcon };