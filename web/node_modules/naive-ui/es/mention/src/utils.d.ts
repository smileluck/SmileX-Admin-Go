//#region src/mention/src/utils.d.ts
/**
 ...
 */
declare function getAbsolutePosition(element: HTMLInputElement | HTMLTextAreaElement): Position;
/**
 * Returns the relative position of the caret in the given element.
 * @param element Input (has to be type='text') or Text Area.
 */
declare function getRelativePosition(element: HTMLInputElement | HTMLTextAreaElement, options?: Options): Position;
/**
 ...
 */
declare function setElementPositionBasedOnCaret(element: HTMLElement, caretElement: HTMLInputElement | HTMLTextAreaElement, offset?: Point, margin?: number, detectBoundary?: boolean, returnOnly?: boolean): Point;
//#endregion
export { Options, Point, Position, getAbsolutePosition, getRelativePosition, setElementPositionBasedOnCaret };