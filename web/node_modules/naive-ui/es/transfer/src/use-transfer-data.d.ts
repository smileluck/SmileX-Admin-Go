import { Filter, Option, OptionValue } from "./interface.js";
//#region src/transfer/src/use-transfer-data.d.ts
...
declare function useTransferData(props: UseTransferDataProps): {
