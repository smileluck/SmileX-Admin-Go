...
var index_cssr_default = cB("tabs", `
...
`, [c("&.transition-disabled", [cB("tabs-tab", `
...
})])]), cB("tabs-nav", [cE("prefix, suffix", `
 border-color: var(--n-tab-border-color);
 `), cB("tabs-nav-scroll-content", `
 border-color: var(--n-tab-border-color);
 `), cM("line-type", [cM("top", [cE("prefix, suffix", `
 ...
 color: var(--n-tab-text-color-hover);
 `)])]), cM("closable", "padding-inline-end: 8px;"), cM("active", `
