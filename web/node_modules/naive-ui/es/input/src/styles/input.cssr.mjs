...
`, [cE("input, textarea", `
 ...
 `)]), c("&:hover", "background-color: var(--n-color-hover);", [cE("state-border", "border: var(--n-border-hover);")]), cM("focus", "background-color: var(--n-color-focus);", [cE("state-border", `
...
const safariStyle = cB("input", [cM("disabled", [cE("input-el, textarea-el", `
 ...
 `)])]);
//#endregion
export { input_cssr_default as default, safariStyle };