...
import collapseLight from "../styles/light.mjs";
import index_cssr_default from "./styles/index.cssr.mjs";
import { computed, createElementBlock, defineComponent, normalizeStyle, openBlock, provide, ref } from "vue";
...
const collapseProps = {
  ...
  onExpandedNamesChange: {
    type: [Function, Array],
    validator: () => {
      if (process.env.NODE_ENV !== "production") warn("collapse", "`on-expanded-names-change` is deprecated, please use `on-update:expanded-names` instead.");
      return true;
    },
    default: void 0
  }
...
var Collapse_default = defineComponent({
  ...
  setup(props, {
    ...
    const themeRef = useTheme("Collapse", "-collapse", index_cssr_default, collapseLight, props, mergedClsPrefixRef);
    function doUpdateExpandedNames(names) {
      ...
      if (onUpdateExpandedNames) call(onUpdateExpandedNames, names);
      if (_onUpdateExpandedNames) call(_onUpdateExpandedNames, names);
  ...
  render() {
    ...
    return openBlock(), createElementBlock("div", {
      class: normalizeClass$1([`${this.mergedClsPrefix}-collapse`, this.rtlEnabled && `${this.mergedClsPrefix}-collapse--rtl`, this.themeClass]),
      style: normalizeStyle(this.cssVars)
    }, [normalizeVNode(() => this.$slots.default?.())], 6);
  }
});
//#endregion
export { collapseInjectionKey, collapseProps, Collapse_default as default };