import { OffsetTarget } from "./utils.js";
import { PropType } from "vue";
//#region src/anchor/src/BaseAnchor.d.ts
interface BaseAnchorInst {
  setActiveHref: (href: string) => void;
}
declare const baseAnchorProps: {
  readonly type: {
...
declare const baseAnchorPropKeys: ("type" | "showRail" | "showBackground" | "bound" | "internalScrollable" | "ignoreGap" | "offsetTarget")[];
...
//#endregion
export { BaseAnchorInst, baseAnchorPropKeys, baseAnchorProps, _default as default };