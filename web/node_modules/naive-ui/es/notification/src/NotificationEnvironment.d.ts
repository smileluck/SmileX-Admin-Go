...
//#region src/notification/src/NotificationEnvironment.d.ts
declare const notificationEnvOptions: {
...
type NotificationOptions = Partial<ExtractPropTypes<typeof notificationEnvOptions>>;
declare const NotificationEnvironment: import("vue").DefineComponent<ExtractPropTypes<{
  internalKey: {
...
//#endregion
export { NotificationEnvironment, NotificationOptions, notificationEnvOptions };