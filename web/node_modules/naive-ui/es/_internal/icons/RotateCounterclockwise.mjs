...
var RotateCounterclockwise_default = replaceable("rotateClockwise", () => (() => {
  const _cache = createVNodeCache("266e62fe230142a7");
...
//#endregion
export { RotateCounterclockwise_default as default };