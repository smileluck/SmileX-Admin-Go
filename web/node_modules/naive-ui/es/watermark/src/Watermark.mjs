...
import watermarkLight from "../styles/light.mjs";
import index_cssr_default from "./styles/index.cssr.mjs";
import { createElementBlock, defineComponent, normalizeStyle, openBlock, ref, watchEffect } from "vue";
...
var Watermark_default = defineComponent({
  ...
  setup(props, {
    ...
    const themeRef = useTheme("Watermark", "-watermark", index_cssr_default, watermarkLight, props, mergedClsPrefixRef);
    ...
    watchEffect(() => {
      ...
      } else warnOnce("watermark", "Canvas is not supported in the browser.");
    });
    return () => {
      const {
        globalRotate,
      ...
      const watermarkNode = (openBlock(), createElementBlock("div", {
        class: normalizeClass$1([`${mergedClsPrefix}-watermark`, globalRotate !== 0 && `${mergedClsPrefix}-watermark--global-rotate`, fullscreen && `${mergedClsPrefix}-watermark--fullscreen`]),
      ...
      return openBlock(), createElementBlock("div", {
        class: normalizeClass$1([`${mergedClsPrefix}-watermark-container`, globalRotate !== 0 && `${mergedClsPrefix}-watermark-container--global-rotate`, fullscreen && `${mergedClsPrefix}-watermark-container--fullscreen`, props.selectable && `${mergedClsPrefix}-watermark-container--selectable`]),
        style: normalizeStyle({
          zIndex: isFullScreenGlobalRotate ? zIndex : void 0
        })
      }, [normalizeVNode(() => slots.default?.()), normalizeVNode(() => watermarkNode)], 6);
    };
  }
});
//#endregion
export { Watermark_default as default, watermarkProps };